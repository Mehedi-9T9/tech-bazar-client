        ...
        <>
            ...
            <form className="card-body grid grid-cols-1 md:grid-cols-2 border-2 m-3 p-5 rounded">
                ...
                <div className="form-control">
                    ...
                    <input type="text" placeholder="Weight" className="input input-bordered" required />
                </div>
                <div className="form-control">
                    <label className="label">
                ...
                <div className="form-control mt-6 md:col-span-2">
                    <button className="bg-[#3B3B98] text-white font-bold py-3 rounded-xl">Add Mobile</button>
                </div>
            </form>
        </>
    );
